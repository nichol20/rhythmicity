...
func (q *Queries) GetPopularAlbums(ctx context.Context, arg GetPopularAlbumsParams) ([]GetPopularAlbumsRow, error) {
	rows, err := q.db.QueryContext(ctx, getPopularAlbums, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
