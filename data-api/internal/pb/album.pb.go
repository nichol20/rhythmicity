...
var file_album_proto_rawDesc = []byte{
	...
	0x74, 0x88, 0x01, 0x01, 0x42, 0x08, 0x0a, 0x06, 0x5f, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x22, 0x37,
	...
	,
...
var file_album_proto_goTypes = []interface{}{
	...
	(*GetPopularAlbumsRequest)(nil), // 2: GetPopularAlbumsRequest
	(*MultipleAlbums)(nil),          // 3: MultipleAlbums
	(*Image)(nil),                   // 4: Image
	(*RequestById)(nil),             // 5: RequestById
	(*RequestByIds)(nil),            // 6: RequestByIds
}
var file_album_proto_depIdxs = []int32{
	4, // 0: AlbumSpotify.images:type_name -> Image
	0, // 1: AlbumMessage.spotify:type_name -> AlbumSpotify
	1, // 2: MultipleAlbums.albums:type_name -> AlbumMessage
	2, // 3: Album.GetPopularAlbums:input_type -> GetPopularAlbumsRequest
	5, // 4: Album.GetAlbum:input_type -> RequestById
	6, // 5: Album.GetSeveralAlbums:input_type -> RequestByIds
	5, // 6: Album.GetAlbumByTrackId:input_type -> RequestById
	5, // 7: Album.GetAlbumsByArtistId:input_type -> RequestById
	3, // 8: Album.GetPopularAlbums:output_type -> MultipleAlbums
	1, // 9: Album.GetAlbum:output_type -> AlbumMessage
	3, // 10: Album.GetSeveralAlbums:output_type -> MultipleAlbums
	1, // 11: Album.GetAlbumByTrackId:output_type -> AlbumMessage
	3, // 12: Album.GetAlbumsByArtistId:output_type -> MultipleAlbums
